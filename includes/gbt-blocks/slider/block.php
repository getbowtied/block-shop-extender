...
//==============================================================================
add_action( 'enqueue_block_editor_assets', 'gbt_18_bs_slider_editor_assets' );
if ( ! function_exists( 'gbt_18_bs_slider_editor_assets' ) ) {
	function gbt_18_bs_slider_editor_assets() {

		wp_enqueue_script(
			'gbt_18_bs_slide_script',
			plugins_url( 'blocks/slide.js', __FILE__ ),
			array( 'wp-blocks', 'wp-components', 'wp-editor', 'wp-i18n', 'wp-element' )
		);
		
		wp_enqueue_script(
			'gbt_18_bs_slider_script',
			plugins_url( 'blocks/slider.js', __FILE__ ),
			array( 'wp-blocks', 'wp-components', 'wp-editor', 'wp-i18n', 'wp-element' )
		);

		wp_enqueue_style(
			'gbt_18_bs_slider_editor_styles',
...
//==============================================================================
add_action( 'enqueue_block_assets', 'gbt_18_bs_slider_assets' );
if ( ! function_exists( 'gbt_18_bs_slider_assets' ) ) {
	function gbt_18_bs_slider_assets() {
		global $theme;
		
		wp_enqueue_style(
			'gbt_18_bs_slider_styles',
