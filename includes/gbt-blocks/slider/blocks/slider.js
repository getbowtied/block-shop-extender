( function( blocks, components, editor, i18n, element ) {
	...
	/* Register Block */
	registerBlockType( 'getbowtied/bs-slider', {
		title: i18n.__( 'Slider', 'block-shop-extender' ),
		icon:
		...
		edit: function( props ) {
			...
			function getColors() {
				...
				if( attributes.pagination ) {
					colors.push(
						{ 
							label: i18n.__( 'Pagination Bullets', 'block-shop-extender' ),
				...
				if( attributes.arrows ) {
					colors.push(
						{ 
							label: i18n.__( 'Navigation Arrows', 'block-shop-extender' ),
			...
			return [
				el(
					InspectorControls,
					{ 
						key: 'gbt_18_bs_slider_inspector'
					},
					el(
						'div',
						{
						...
						el(
							ToggleControl,
							{
								key: "gbt_18_bs_slider_full_height",
								label: i18n.__( 'Full Height', 'block-shop-extender' ),
						...
						el(
							RangeControl,
							{
								key: "gbt_18_bs_slider_custom_height",
								value: attributes.customHeight,
								allowReset: false,
								initialPosition: 800,
								min: 100,
								max: 1000,
								label: i18n.__( 'Custom Desktop Height', 'block-shop-extender' ),
						...
						el(
							RangeControl,
							{
								key: "gbt_18_bs_slider_slides",
								value: attributes.slides,
								allowReset: false,
								initialPosition: 3,
								min: 1,
								max: 6,
								label: i18n.__( 'Number of Slides', 'block-shop-extender' ),
								onChange: function( newNumber ) {
						...
						el(
							ToggleControl,
							{
								key: "gbt_18_bs_slider_pagination",
	              				label: i18n.__( 'Pagination Bullets', 'block-shop-extender' ),
						...
						el(
							PanelColorSettings,
							{
								key: 'gbt_18_bs_slider_arrows_color',
				...
				el( 'div',
					{
						key: 				'gbt_18_bs_editor_slider_wrapper',
						className: 			'gbt_18_bs_editor_slider_wrapper',
						'data-tab-active': 	attributes.activeTab
					},
					el( 'div',
						{
							key: 		'gbt_18_bs_editor_slider_tabs',
							className: 	'gbt_18_bs_editor_slider_tabs'
						},
						getTabs()
					),
					el(
						InnerBlocks,
						{
							key: 'gbt_18_bs_editor_slider_inner_blocks ',
							template: getTemplates(),
	                        templateLock: "all",
	            			allowedBlocksNames: ["getbowtied/bs-slide"]
						},
					),
				),
			];
		...
		save: function( props ) {
			...
			return el( 
				'div',
				{
					key: 'gbt_18_bs_slider_wrapper',
					className: 'gbt_18_bs_slider_wrapper'
				},
				el( 
					'div',
					{
						key: 'gbt_18_bs_slider_container',
						className: attributes.fullHeight ? 'gbt_18_bs_slider swiper-container full_height' : 'gbt_18_bs_slider swiper-container',
						style:
						{
					...
					!! attributes.pagination && el(
						...
						{
							key: 'gbt_18_bs_slider_pagination',
							className: 'gbt_18_bs_slider_pagination',
							style:
							{
